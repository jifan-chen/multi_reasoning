# $1 cuda, $2 save dir
#OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=$1 allennlp train experiments/hotpot_chain/noam_hotpot_legacy_rl_multiprocess.json -s ./save/$2 --include-package my_library -f
