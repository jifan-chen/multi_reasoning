# $1 cuda, $2 save dir
#OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=$1 allennlp train experiments/hotpot_gate_w_answer/noam_my_hotpot_legacy_multiprocess_full.json -s ./save/$2 --include-package my_library -f
