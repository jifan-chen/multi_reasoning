...
#mkdir -p ./save/$2
#OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=$1 allennlp train experiments/hotpot_gate_w_answer/noam_my_hotpot_legacy_multiprocess_crossval$3.json -s ./save/$2/$2train$3valdev/ --include-package my_library -f
