...
@TokenEmbedder.register("my-bert-pretrained")
class PretrainedBertEmbedder(BertEmbedder):
    ...
    scalar_mix_parameters: ``List[float]``, optional, (default = None)
        ...
        training.
    """
    def __init__(self, pretrained_model: str, requires_grad: bool = False, max_pieces: int = 512,
                 top_layer_only: bool = False, scalar_mix_parameters: List[float] = None) -> None:
