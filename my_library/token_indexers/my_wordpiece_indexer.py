    ...
    def tokens_to_indices(self,
        ...
        if len(flat_wordpiece_ids) <= window_length:
            ...
            try:
                ...
                print("Exception flat_wordpiece_ids:", flat_wordpiece_ids)
                print("Exception flat_token_type_ids:", flat_token_type_ids)
                print("Exception tokens:", tokens)
...
@TokenIndexer.register("my-bert-pretrained")
