...
class AcademicPaperClassifier(Model):
    ...
    The basic models structure: we'll embed the title and the abstract, and encode each of them with
    ...
    text_field_embedder : ``TextFieldEmbedder``, required
        Used to embed the ``tokens`` ``TextField`` we get as input to the models.
    ...
    initializer : ``InitializerApplicator``, optional (default=``InitializerApplicator()``)
        Used to initialize the models parameters.
