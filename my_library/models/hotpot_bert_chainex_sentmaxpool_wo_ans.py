...
@Model.register("hotpot_bert_chainex_sentmaxpool_wo_ans")
...
@Seq2SeqEncoder.register("bert_sentmaxpool_span_gate")
class SpanGate(Seq2SeqEncoder):
    ...
    def forward(self,
        ...
        max_pooled_span_emb = torch.max(spans_tensor, dim=2)[0]
