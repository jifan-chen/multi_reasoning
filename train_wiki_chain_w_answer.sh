# $1 cuda, $2 save dir
#OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=$1 allennlp train experiments/wikihop_chain_w_answer/wiki_noam_hotpot_legacy_rl_multiprocess.json -s ./save/$2 --include-package my_library -f
